        ...
        try:
            ...
            if rule:
                if isinstance(rule, str):
                    rule = HOSTS[rule]
                rand, waittime, ttl, mss, addrlist = rule
                if rand:
